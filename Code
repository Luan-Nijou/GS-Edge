...
void loop() {
  ...
  /* Verifica o estado atual do sistema. Cada caso, 
     lê a luminosidade, a temperatura, a umidade e 
     a reserva do líquido.
  */
   switch (LumiState) {
  	case 0:      
      noTone(BUZZER_PIN);
